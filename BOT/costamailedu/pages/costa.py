...
class Costa:
    ...
    def save_info(self):
        ...
        with open("accountinfo.txt", 'a') as txtFile:
            ...
            txtFile.writelines("DOB ==> {}/{}/{}\n".format(self.birth_day, self.birth_month, self.birth_year))
            txtFile.writelines("{}\n".format(self.cccid))
            txtFile.writelines("Your final Login Password ==> {}{}03241997CCCD\n".format(self.firstname[0].upper(),
                                                                                         self.lastname[0].lower()))
